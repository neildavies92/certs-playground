...
variable "aws_region" {
  ...
  validation {
    condition     = can(regex("^(eu|us|ap|sa|ca|af)-[a-z]+-[1-9]$", var.aws_region))
    error_message = "The AWS region must be in the format: <region-prefix>-<location>-<number> (e.g. eu-west-2)"
  }
}
